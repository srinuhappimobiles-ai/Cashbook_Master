...
def process_cashbook_image(pil_img, target_branch):
  """Ultra-lightweight and fast OCR using Tesseract (Zero server throttling)."""
...
table_key = (
    f"master_editor_{work_mode}_{len(selected_branches)}_{len(db['store_data'])}"
)
